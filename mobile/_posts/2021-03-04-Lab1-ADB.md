In this lab we'll take a look at adb and what is possible on an android AVD.
...
adb reboot```
mogelijks: ``cat /dev/null > /data/system/password.key``
...
```adb shell
sqlite3 /data/data/sg.vp.owasp_mobile.omtg_android/databases/privateNotSoSecure
